...
## 🎯 Objetivo
Desenvolver uma ferramenta de linha de comando (CLI) em Node.js que receba um arquivo de texto contendo um JSON bruto (minificado ou bagunçado) e imprima o JSON formatado e indentado corretamente (*pretty-print*).
...
* **Arquitetura Limpa:** Aplique princípios de Clean Code. Separe as responsabilidades: a função que lê o arquivo não deve ser a mesma que formata os dados ou a que exibe o resultado.
